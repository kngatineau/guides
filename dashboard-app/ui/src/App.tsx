...
function App() {
  ...
  const [areaChartArgs, setAreaChartArgs] = useState<any | null>(null);
  ...
  return (
    <main className="h-full p-10 bg-tremor-background-muted dark:bg-dark-tremor-background-muted">
      <Title>Dashboard</Title>
      <Text>An internal sales dashboard</Text>
